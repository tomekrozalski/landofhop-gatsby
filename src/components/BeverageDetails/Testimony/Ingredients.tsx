      ...
      {ingredientsDescription.label && (
        <>
          <dt>
            <FormattedMessage
              id={`beverage.details.${
                ingredientsDescription.label.complete
                  ? 'ingredients'
                  : 'contains'
              }`}
            />
          ...
          <dd>
            <SourceGroup>
              <Label>
                <SourceItem
                  lang={getLangAttr(ingredientsDescription.label.language)}
                >
              ...
              {ingredientsDescription.producer &&
                ingredientsDescription.label.complete ===
                  ingredientsDescription.producer.complete && (
                  <Producer>
                    <SourceItem
                      lang={getLangAttr(
                        ingredientsDescription.producer.language,
                      )}
                    >
          ...
          <>
            ...
            <dd>
              <SourceGroup>
                <Producer>
                  <SourceItem
                    lang={getLangAttr(ingredientsDescription.producer.language)}
                  >
                    {ingredientsDescription.producer.value}
                  </SourceItem>
                </Producer>
